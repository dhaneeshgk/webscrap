...
if __name__ == "__main__":
    ...
    print("To start with Article Metadata Import\n")
    ...
    print("To start with Author Metadata Import\n")
    url_am.AuthorMetadata(import_urls("AuthorMetadata"),driver=ch)
    print("Completed with Author Metadata Import\n")
    input("Press enter to start next web import\n\n")
    print("To start with Issues Metadata Import with details available related to article")
